# ONE-STEP | Spring 프로젝트 : 예술가들의 성장을 도와주는 플랫폼 서비스

## 🖥️ 프로젝트 소개
예술가들이 한 걸음 씩 성장해 나갈 수 있도록 도와주는 예술가 커뮤니티 플랫폼
...
## 🧑‍🤝‍🧑 맴버구성 - 백엔드 업무
 - 팀장  : 손성민 - 회원가입, 로그인,  크라우드 펀딩
 - 부팀장 : 임준영 - 팬 커뮤니티
 - 팀원1 : 정재원 - 관리자 페이지, 공지사항
 - 팀원2 : 임지성 - 마이 페이지
 - 팀원3 : 조남호 - 메인 페이지, 예술가, 문의작성
