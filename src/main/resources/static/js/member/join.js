...
// join
const $joinInputs = $("div.join input[id = 'email'], div.join input[id ='password'], div.join input[id ='nickname']");
...
let joinBlurMessages = ["이메일을 입력하세요.", "비밀번호를 입력하세요.", "닉네임을 입력하세요."];
let joinRegexMessages = ["이메일 주소를 확인해주세요.", "공백 제외 영어 및 숫자, 특수문자 모두 포함하여 10~20자로 입력해주세요.", "영문 혹은 한글로 2자~20자로 입력해주세요."];
        ...
        $.ajax({
            ...
            success: function(result){
                if(result){
                    ...
                    $joinHelp.eq(i).text("사용할 수 있는 이메일이에요!");
